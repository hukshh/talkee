...
export function Sidebar({
    ...
    return (
        <div className={clsx(
            ...
            <div className="glass-grey h-full md:h-[calc(100vh-2rem)] rounded-none md:rounded-[3rem] md:m-4 flex flex-col overflow-hidden border-zinc-800 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                {/* Mobile Social Header */}
                <div
                    className="flex md:hidden items-center justify-between p-6 pb-4 border-b border-white/10 bg-[#050505]/60 backdrop-blur-3xl sticky top-0 z-[60]"
                    style={{ paddingTop: 'max(1.5rem, env(safe-area-inset-top))' }}
                >
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 glass-silver rounded-[1.5rem] flex items-center justify-center border border-white/20 shadow-[0_0_30px_rgba(255,255,255,0.1)]">
                            <Sparkles className="w-6 h-6 text-white" />
                        </div>
                        <div className="space-y-0">
                            <h1 className="text-3xl font-black italic uppercase tracking-tighter leading-none vibe-gradient">
                                Vibe Mingle
                            </h1>
                            <p className="text-[8px] font-black text-zinc-500 uppercase tracking-[0.4em] inline-flex items-center gap-1.5 px-0.5">
                                <span className="w-1 h-1 rounded-full bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]" />
                                Real-time Vibes
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col w-full h-full p-4 md:p-8 space-y-6 md:space-y-8">
                    <div className="hidden md:flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-white/5 rounded-2xl flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.1)]">
                                <Sparkles className="w-5 h-5 text-white" />
                            </div>
                            <h1 className="text-3xl font-black text-white italic uppercase tracking-tighter">
                                Vibe <span className="text-zinc-400 italic">Mingle</span>
                            </h1>
                        </div>
                        <div className="flex items-center gap-3">
                            <NotificationsPanel onSelectUser={onSelectConversation} />
                    ...
                    <div className="flex-1 overflow-y-auto space-y-8 pr-2 custom-scrollbar">
                        <div className="space-y-6">
                            ...
                            <div className="hidden md:flex gap-2 p-1 glass-darker rounded-2xl border border-white/5">
                                <button
                    ...
                    <div className="hidden md:flex pt-6 border-t border-white/5 items-center justify-between px-2">
